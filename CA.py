...
# pdf_file = r'C:\Users\76656\Desktop\pdf处理\CA.pdf'
...
# 原始PDF文件路径
# pdf_path = r'C:\Users\76656\Desktop\pdf处理\CA.pdf'
...
# 新的文件名
new_file_name = f"prime CA shipping {current_date} (SecondPriority).pdf"
...
# 新的文件名
new_file_name = f"prime CA shipping {current_date} (FirstPriority).pdf"
