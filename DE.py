...
#     # 保存页码为JPEG并进行识别
#     path_image = os.path.join(os.path.dirname(pdf_file), f'{page_num}.jpg')
#     page.save(path_image, "JPEG")
...
# 新的文件名
new_file_name = f"prime DE shipping {current_date} (SecondPriority).pdf"
...
# 新的文件名
new_file_name = f"prime DE shipping {current_date} (FirstPriority).pdf"
